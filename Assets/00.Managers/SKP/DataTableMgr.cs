...
public static class DataTableMgr
{
    ...
    static DataTableMgr()
    {
        ...
        tables.Add(typeof(ExpTable), new ExpTable());               //±¤ÈÆ Ãß°¡
        tables.Add(typeof(BreakLimitTable), new BreakLimitTable()); //±¤ÈÆ Ãß°¡
        tables.Add(typeof(EquipTable), new EquipTable());           //±¤ÈÆ Ãß°¡
        tables.Add(typeof(EquipExpTable), new EquipExpTable());     //±¤ÈÆ Ãß°¡
